...
<template>
	<div class="Cart">
		...
		<table id="cartTable" v-show="message.length!==0">
	        <thead>
	            <tr>
	                <th width="60"><label><input class="check-all check" type="checkbox" @click="AllCheck">&nbsp;全选</label></th>
	                <th width="200">商品</th>
	                <th width="100">单价</th>
	                <th width="90">数量</th>
	                <th width="80">小计</th>
	        ...
	        <tbody>
	            <tr v-for="(item,index) in message">
	                <td class="checkbox"><input class="check-one check" type="checkbox" @click="SingleCheck"/></td>
	    ...
	    <div class="foot" id="foot" v-show="message.length!==0">
	        <label class="fl select-all"><input type="checkbox" class="check-all check" v-model="checked" @change="SingleCheck()"/>&nbsp;全选</label>
